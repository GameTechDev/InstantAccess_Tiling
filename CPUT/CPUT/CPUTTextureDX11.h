...
public:
    ...
    static CPUTResult     GetSRGBEquivalent(DXGI_FORMAT inFormat, DXGI_FORMAT& sRGBFormat) {return CPUT_SUCCESS;};;
	static bool           DoesExistEquivalentSRGBFormat(DXGI_FORMAT inFormat) {return true;};
