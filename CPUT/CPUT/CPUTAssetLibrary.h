...
public:
    ...
    cString &GetMediaDirectoryName()    { return mMediaDirectoryName; }
    cString &GetAssetSetDirectoryName() { return mAssetSetDirectoryName; }
    cString &GetModelDirectoryName()    { return mModelDirectoryName; }
    cString &GetMaterialDirectoryName() { return mMaterialDirectoryName; }
    cString &GetTextureDirectoryName()  { return mTextureDirectoryName; }
    cString &GetShaderDirectoryName()   { return mShaderDirectoryName; }
    cString &GetFontDirectoryName()     { return mFontDirectoryName; }
