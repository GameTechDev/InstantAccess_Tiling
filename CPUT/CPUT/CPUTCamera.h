...
protected:
    ...
    bool  mPerspectiveProjection; // true if using perspective projection -- orthographic otherwise
...
public:
    ...
    void            SetPerspectiveProjection(bool proj) { mPerspectiveProjection = proj;};
